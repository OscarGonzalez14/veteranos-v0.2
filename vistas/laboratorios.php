  ...
  <div class="content-wrapper">
    <section class="content">
      ...
      <div class="form-row">
        ...
        <button class="btn btn-info barcode_actions" data-toggle="modal" data-target="#barcode_ingresos_lab" onClick='input_focus_clearb()'><i class="fas fa-download"></i> Recibir</button>
         </div>
        </div> 
