  ...
  <div class="content-wrapper">
    <section class="content">
      ...
      <?php include 'ordenes/header_status_veteranos.php'; ?>
        ...
        <button class="btn btn-info barcode_actions float-right" data-toggle="modal" data-target="#modal_acciones_veteranos" onClick='input_focus_clearb()' style="border: solid 1px #1f2e50"><i class="fas fa-download"></i> Recibir</button>
